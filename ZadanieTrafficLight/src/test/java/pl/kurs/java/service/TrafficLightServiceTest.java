...
public class TrafficLightServiceTest {
    ...
    private TrafficQueueSensor trafficQueueSensor;
    ...
    public void init() {
        ...
        trafficQueueSensor = Mockito.mock(TrafficQueueSensor.class);
        service = new TrafficLightService(distanceSensor, speedSensor, lightController, pedestrianSensor,
                emergencyModeController, privilegedVehicleSensor, weatherSensor, pedestrianButton, temperatureSensor, trafficQueueSensor);
    }
    ...
    public void shouldShortenedWaitingTimeForGreenLightForVechicles(){
        Mockito.when(trafficQueueSensor.getVechicleCount()).thenReturn(11);
