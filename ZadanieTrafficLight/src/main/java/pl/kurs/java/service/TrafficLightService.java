...
public class TrafficLightService {
    ...
    private final TrafficQueueSensor trafficQueueSensor;
    ...
    public TrafficLightService(DistanceSensor distanceSensor, SpeedSensor speedSensor, LightController lightController,
                               ...
                               PedestrianButton pedestrianButton, TemperatureSensor temperatureSensor, TrafficQueueSensor trafficQueueSensor) {
    ...
    private boolean highTraffic(){
        return trafficQueueSensor.getVechicleCount() > 10;
    }
